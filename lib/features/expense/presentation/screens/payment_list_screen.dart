...
class _PaymentListViewState extends State<_PaymentListView> {
  ...
  void _openDetail(BuildContext context, dynamic item, PaymentListProvider p) {
    ...
    final workflowInstanceId = item is PaymentListItem
        ? item.workflowInstanceId
        : item is AdvanceListItem
            ? item.workflowInstanceId
            : (item as SettlementListItem).workflowInstanceId;

    final route = item is SettlementListItem
        ? MaterialPageRoute(
            builder: (_) => AdvanceSettlementsDetailScreen(
                id: id,
                workflowInstanceId: workflowInstanceId.toString(),
                color: widget.color))
        : item is AdvanceListItem
            ? MaterialPageRoute(
                builder: (_) => AdvancePaymentsDetailScreen(
                    id: id,
                    workflowInstanceId: workflowInstanceId.toString(),
                    color: widget.color))
            : MaterialPageRoute(
