...
import '../models/advance_settlement_model.dart';
import '../models/payment_model.dart'; // ✅ Fix #1: chữ thường
...
class PaymentRepository {
  ...
  Future<void> approve(String workflowInstanceId) async {
    final res = await _api.post(
        '/api/expense-workflow-instance/approve/$workflowInstanceId',
        body: {});
    if (res['isSuccess'] != true) {
  ...
  Future<void> reject(String workflowInstanceId, String reason) async {
    final res = await _api.post(
        '/api/expense-workflow-instance/reject/$workflowInstanceId',
        body: {'Message': reason});
    if (res['isSuccess'] != true) {
