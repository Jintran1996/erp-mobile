...
class _BudgetPlanDetailView extends StatelessWidget {
  ...
  // ── AppBar — giống expense: subId + badge + datetime ─────────────
  ...
  Widget _buildActionBar(
    ...
    return Container(
      padding: const EdgeInsets.fromLTRB(
          16, 12, 16, 24), // Chừa khoảng trống cho cằm iPhone/Android
      decoration: BoxDecoration(
        color: Colors.white,
        boxShadow: [
          BoxShadow(
            ...
            spreadRadius: 0,
            blurRadius: 20,
            offset: const Offset(0, -4), // Đổ bóng ngược lên trên
          ),
        ],
      ),
      child: Row(
        children: [
          // Nút Từ chối: Chiếm không gian nhỏ hơn, dùng màu đỏ nhẹ nhàng mềm mại
          Expanded(
            flex: 3,
          ...
          // Nút Duyệt: To hơn, đổ bóng, màu xanh Emerald sang trọng
          Expanded(
            flex: 5,
            child: Container(
              decoration: BoxDecoration(
